...
const Notification: FC<NotificationProps> = ({ notification }) => {
  return (
    <Root>
      <Item>
        <Link disableBorderOnHover href={`/communities/profile/${notification.author._id}`}>
        ...
        {notification.like && (
          <Action>
            <div>
              liked your{' '}
              <Link disableBorderOnHover href={`/communities/post/${notification.like.post._id}`} size="sm">
                post
              </Link>
            </div>
            {notification.like.post.image && (
              <Link disableBorderOnHover href={`/communities/post/${notification.like.post._id}`}>
                <PostImage>
        ...
        {notification.message && (
          <Action>
            <Link size="sm" href={`/communities/messages/${notification.author._id}`}>
              messaged you
            </Link>
          </Action>
        )}
