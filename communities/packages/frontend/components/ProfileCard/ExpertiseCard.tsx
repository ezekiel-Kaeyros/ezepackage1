...
import AddExpertize from './AddExpertize/AddExpertize';
...
<Spacing bottom="sm">
      <Root>
        ...
        <ImageContainer>
          <Image alt="icon card" width={60} height={50} src={Layer} />
        </ImageContainer>
                    
        <FullName> Adding a skill to your profile </FullName>
        <Description>Make yourself important by adding skills to your profile to enhance your experience</Description>
                  
        <MyButton>
        <AddExpertize searchQuery={searchQuery} /> 
