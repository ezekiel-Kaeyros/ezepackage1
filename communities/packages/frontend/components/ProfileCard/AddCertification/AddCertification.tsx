...
const AddCertification: FC<SettingsCreateUserProps> = ({ searchQuery }) => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isPopupOpen} close={() => setIsPopupOpen(false)} title="Add a license or certification">
        <form onSubmit={onSubmit}>
          
          <InputText name="name" label="Name*" placeholder="Ex: Foundations of User Experience (UX) Design " value={values.fullName} onChange={onChange} />
          
          <Spacing bottom="sm" />

          <InputText name="name" label="Issuing body*" placeholder="Ex: Coursera Inc." value={values.fullName} onChange={onChange} />
          <Spacing bottom="sm" />
         
          <InputText name="name" label="Issue date*" placeholder="Ex: Novembre 2022" value={values.fullName} onChange={onChange} />
          <Spacing bottom="sm" />
          <InputText name="name" label="Expiry date*" placeholder="Ex: December 2022" value={values.fullName} onChange={onChange} />
