...
authRouter.get("/logout", (req, res) => {
  req.logout((err) => {
    ...
    req.session.destroy((err) => {
      ...
      const auth0LogoutUrl = `https://dev-7htaauz8ydzvm6gp.us.auth0.com/v2/logout?returnTo=${process.env.REDIRECT_ORIGIN}&client_id=3MRQwdMikF9rCgf5pYqK1xuj75Ruaigk`;
